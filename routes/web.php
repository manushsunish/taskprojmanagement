...
Route::middleware('auth')
    ...
    Route::controller(\App\Http\Controllers\Manager\ProjectController::class)->group(function () {
        Route::get('assigned-projects', 'assignedProjects')->name('assigned.projects');
    });
    Route::controller(\App\Http\Controllers\Manager\TaskController::class)->group(function () {
        Route::get('assigned-tasks', 'assignedTasks')->name('assigned.tasks');
    });
});
